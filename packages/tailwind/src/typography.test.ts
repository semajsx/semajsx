...
describe("font style utilities", () => {
  ...
  it("generates not-italic correctly", () => {
    expect(fontStyle["not-italic"]._).toBe("not-italic");
    expect(fontStyle["not-italic"].__cssTemplate).toBe(".not-italic { font-style: normal; }");
  });
});
...
describe("letter spacing utilities", () => {
  ...
  it("generates tracking-tight correctly", () => {
    ...
    expect(letterSpacing["tight"].__cssTemplate).toBe(
  ...
  it("generates tracking-widest correctly", () => {
    ...
    expect(letterSpacing["widest"].__cssTemplate).toBe(
...
describe("text decoration utilities", () => {
  ...
  it("generates no-underline correctly", () => {
    expect(textDecoration["no-underline"]._).toBe("no-underline");
    expect(textDecoration["no-underline"].__cssTemplate).toBe(
      ".no-underline { text-decoration-line: none; }",
    );
  });

  it("generates line-through correctly", () => {
    expect(textDecoration["line-through"]._).toBe("line-through");
  });
});
...
describe("text transform utilities", () => {
  ...
  it("generates uppercase correctly", () => {
    ...
    expect(textTransform["uppercase"].__cssTemplate).toBe(
  ...
  it("generates normal-case correctly", () => {
    expect(textTransform["normal-case"]._).toBe("normal-case");
    expect(textTransform["normal-case"].__cssTemplate).toBe(
