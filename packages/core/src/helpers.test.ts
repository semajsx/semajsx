...
describe("helpers", () => {
  describe("when()", () => {
    ...
    it("should return content when condition is true", () => {
      ...
      expect(result.peek()).toBe(content);
    });
    ...
    it("should support lazy evaluation with function", () => {
      ...
      expect(result.peek()?.type).toBe("div");
    });
  ...
  describe("resource()", () => {
    ...
    it("should use custom pending content", () => {
      ...
      expect(result.peek()).toBe(pending);
    });
    ...
    it("should handle rejected promise", async () => {
      ...
      expect(result.peek()).toBeNull(); // Stays at pending value
  ...
  describe("stream()", () => {
    ...
    it("should update with each yielded value", async () => {
      ...
      expect(result.peek()).toBe(second);
    });
