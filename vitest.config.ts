...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "semajsx/jsx-runtime": path.resolve(__dirname, "./src/jsx-runtime.ts"),
      ...
      "semajsx/dom/jsx-runtime": path.resolve(
        __dirname,
        "./src/dom/jsx-runtime.ts",
      ),
      "semajsx/dom/jsx-dev-runtime": path.resolve(
        __dirname,
        "./src/dom/jsx-dev-runtime.ts",
      ),
      "semajsx/server": path.resolve(__dirname, "./src/server/index.ts"),
      "semajsx/client": path.resolve(__dirname, "./src/client/index.ts"),
      "semajsx/terminal": path.resolve(__dirname, "./src/terminal/index.ts"),
      "semajsx/terminal/jsx-runtime": path.resolve(
        __dirname,
        "./src/terminal/jsx-runtime.ts",
      ),
      "semajsx/terminal/jsx-dev-runtime": path.resolve(
        __dirname,
